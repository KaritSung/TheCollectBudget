...
import 'package:flutter_test_noti/internal/navbar/_setting/change%20tel.dart';
...
class Otp2_2 extends StatefulWidget {
  String? tel;
  Otp2_2(this.tel);
  @override
  State<Otp2_2> createState() => _Otp2_2State();
} 

class _Otp2_2State extends State<Otp2_2> {
  ...
  initState() {
    controller.text = "";
    loginWithPhone("+66"+ widget.tel.toString().substring(1));
    print("+66"+ widget.tel.toString().substring(1));
    super.initState();
  }
   ...
   void _fetchData(BuildContext context) async {
    ...
    try{
       var response = await http.post(
          Uri.parse("http://apbcm.ddns.net:5000/api/updateTelUser?Tel="+context.read<getTal>().Tel),
          body: {         
              "user_Tel":widget.tel
          }
      );
      ...
      if(response.statusCode==200){
        ...
        Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>Homepage(widget.tel)), (Route<dynamic> route) => false);
      }else{
        print("error-sent");
      }
  } catch(e){
