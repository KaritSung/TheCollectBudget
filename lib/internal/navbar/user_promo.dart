...
import '../provice/telModel.dart';

class User_promo extends StatefulWidget {
  User_promo({Key? key}) : super(key: key);

  @override
  State<User_promo> createState() => _User_promoState();
}

class _User_promoState extends State<User_promo> {
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.data != null) {
            ...
            return Center(
              child: Text("ไม่พบโปรโมชั่นของท่าน"),
            );
          }
        },
      ),
