...
class Etab2 extends StatefulWidget {
  

  @override
  State<Etab2> createState() => _Etab2State();
}

class _Etab2State extends State<Etab2> {
  bool data = false;
  var x ;
  @override
  void initState() {
  ...
  Future<List<Withdraw>> getWithdraw() async{
    ...
    try{
    final url = Uri.parse('http://apbcm.ddns.net:5000/api/getWithdraw?Tel='+context.read<getTal>().user_tel+'&status=all');
